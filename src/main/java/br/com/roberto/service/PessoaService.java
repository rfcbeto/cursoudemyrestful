...
public class PessoaService {
	...
	public List<PessoaVO> retornaPessoas() throws PessoaException{
	...
	public PessoaVO atualizar(PessoaVO pessoaVO) {
		Pessoa entidade = repository.findById(pessoaVO.getId()).orElseThrow(() -> new PessoaException("Pessoa não encontrada"));
